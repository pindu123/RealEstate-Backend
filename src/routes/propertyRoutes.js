...
propertyRoutes.get(
  "/maxPrice/:type/:sell/:rent/:lease/:flat/:house",
  cache("5 seconds"),
  maxPrice
);
...
propertyRoutes.get(
  "/maxSizeForAllProps/:type/:sell/:rent/:lease/:flat/:house/:sold/:unsold",
  cache("5 seconds"),
  maximumSizeForAllProps
);
propertyRoutes.get(
  "/maxSize/:type/:sell/:rent/:lease/:flat/:house/:sold/:unsold",
  cache("5 seconds"),
  maximumSize
);
propertyRoutes.get(
  "/maxPriceForAllProps/:type/:sell/:rent/:lease/:flat/:house",
  cache("5 seconds"),
  maxPriceForAllProps
);
propertyRoutes.get(
  "/countOfRatings/:propertyId/:propertyType",
  getCountOfRatings
);
