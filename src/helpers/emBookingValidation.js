...
//client booking with an agent
const clientBookingSchema = Joi.object({
  clientId: Joi.string().required(),

  role: Joi.number().valid(4).required(),

  agentId: Joi.string().required(),

  estId: Joi.string().required(),
...
module.exports = {
    clientBookingSchema,agentBookingSchema,validateRoleAndStatus, validateBookingIdStatus, validateIds,validateFilterData, validateId
};
